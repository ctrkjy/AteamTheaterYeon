  ...
  return (
    <div className="App">
      <header id="top" className="App-header">
        ...
        <div className="header-GNB">
          <ul>
            ...
            <a href="#"><img src={profileLogo} className="profileLogo" /></a>
          </ul>
        </div>
      </header>
      ...
      <footer className="footer">
        ...
        <div className="footerInfo" >에이팀씨어터안내 고객센터 자주묻는질문 1:1문의 고객센터: 고객 센터로 전화 또는 이메일 문의를 주실 경우 상담을 도와 드리도록 하겠습니다 010 - 5872 - 6303 이메일ctrkjy@naver.com
현금 등 구매에 관하여 FDK(02-006-00027) 구매안전(에스크로) 서비스에 가입하여
고객님의 안전한 거래를 보장하고 있습니다. | 
법적고지 회사소개 인재채용 이용약관 개인정보처리방침 로고하나박고 경기도 안산시 상록구 한양대학로 55 학연산클러스터지원센터 Tel.031-400-4677
대표자명 김정연 · 개인정보보호책임자 김정연 · 사업자등록번호 2001-12-26 · 통신판매업신고번호 제 4545호
COPYRIGHT © AteamTheater, Inc. All rights reserved</div>
</div>
      </footer>
    </div>
  );
